...
const Contact = () => {
  ...
  const handleSubmit = () => {
    toast("Your meassage has been send successfully");
  };
  return (
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <div className="from-control">
              <input
                ...
                className="input border-1 border-[#a56f7c] w-full max-w-xs  my-3 rounded-none text-black"
                required
              />
            </div>
            <div className="from-control ">
              <input
                ...
                className="input border-1 border-[#a56f7c] w-full max-w-xs text-black  my-3 rounded-none"
                required
              />
            </div>
            <div className="from-control">
